...
static unsigned bt_config_power_on[] = {	
	...
	GPIO_CFG(57, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),	/* WAKE */
	GPIO_CFG(20, 0, GPIO_INPUT,  GPIO_NO_PULL, GPIO_2MA),	/* HOST_WAKE */
};
static unsigned bt_config_power_off[] = {	
	...
	GPIO_CFG(57, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA),	/* WAKE */
	GPIO_CFG(20, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA),	/* HOST_WAKE */
};
...
static int bluetooth_power(int on)
{
	...
	if (on) {		
		...
		rc = vreg_set_level(vreg_bt, OUT2600mV);
		if (rc) {
		...
		gpio_direction_output(88, 1);	/* BT_VREG_CTL */
	} else {
		gpio_direction_output(88, 0);	/* BT_VREG_CTL */
...
#ifdef CONFIG_SENSORS_BMA220
{
		I2C_BOARD_INFO("bma220",BMA220_I2C_ADDR),
},
#endif
...
static uint32_t camera_on_gpio_table[] = {
	/* parallel CAMERA interfaces */
//	GPIO_CFG(0,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* nCAM_3M_RST */
...
static struct mmc_platform_data msm7x2x_sdcc_data_2 = {
	.ocr_mask	= MMC_VDD_28_29,
	.translate_vdd	= msm_sdcc_setup_power,
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
};
...
#ifdef CONFIG_MMC_MSM_SDC2_SUPPORT
		msm_add_sdcc(2, &msm7x2x_sdcc_data_2);
#endif
#ifdef CONFIG_MMC_MSM_SDC3_SUPPORT
...
MACHINE_START(EUROPA, "Samsung Europa")
