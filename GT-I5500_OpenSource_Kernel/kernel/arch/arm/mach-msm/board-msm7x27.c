...
#else
#if 0 //CHJ
#define MSM_PMEM_MDP_SIZE   0xAE6000 // 0x17E6000 //0x1121000
//#define MSM_PMEM_MDP_SIZE   0x1791000 //0x1121000
#define MSM_PMEM_ADSP_SIZE  0x77F000
#define MSM_PMEM_AUDIO_SIZE	0x121000
//#define MSM_FB_SIZE     0x100000 // 0x4B000
#define MSM_FB_SIZE 0x500000	//qct patch - 24bpp
#define MSM_GPU_PHYS_SIZE   SZ_2M
#define PMEM_KERNEL_EBI1_SIZE   0x64000
#else
...
#define DEC1_FORMAT ((1<<MSM_ADSP_CODEC_WAV)|(1<<MSM_ADSP_CODEC_ADPCM)| \
	(1<<MSM_ADSP_CODEC_YADPCM)|(1<<MSM_ADSP_CODEC_QCELP))  //CHJ
...
static void __init msm_msm7x2x_allocate_memory_regions(void)
{
	...
	if (size) {
		addr = alloc_bootmem(size);
//CHJ		android_pmem_audio_pdata.start = __pa(addr);
